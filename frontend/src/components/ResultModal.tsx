...
import { DIFFICULTIES, createGameRoute, STORAGE_KEYS } from '../lib/constants'
...
export default function ResultModal({
  ...
  return (
    <Dialog
      isOpen={isOpen}
      onClose={onClose}
      titleId="result-modal-title"
      panelClassName="w-full max-w-md rounded-2xl bg-background p-6 shadow-2xl"
    >
      {/* Close button */}
      <button
        onClick={onClose}
      ...
      <div className="mb-6 text-center">
        <h2 id="result-modal-title" className="text-2xl font-bold text-foreground">
          🎉 Puzzle Complete!
        </h2>
