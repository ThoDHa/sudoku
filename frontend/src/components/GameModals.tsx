  ...
  return (
    <>
      ...
      {solveConfirmOpen && (
        ...
        >
          <h2 id="solve-confirm-title" className="mb-2 text-lg font-bold text-foreground">
            Solve Puzzle?
          </h2>
      ...
      {showClearConfirm && (
        <Dialog
          ...
          panelClassName="w-full max-w-sm rounded-2xl bg-background p-6 shadow-2xl"
        >
          <h2 id="clear-confirm-title" className="mb-2 text-lg font-bold text-foreground">
      ...
      {showSolutionConfirm && (
        ...
        >
          <h2 id="solution-confirm-title" className="mb-2 text-lg font-bold text-foreground">
            Too Many Conflicts
          </h2>
          <p className="mb-6 text-sm text-foreground-muted">
            {unpinpointableErrorMessage ||
