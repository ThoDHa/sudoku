          ...
          {gameActions && (
            <div className="space-y-1">
              ...
              >
                <span className="flex items-center gap-3">
                  <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7H5a2 2 0 00-2 2v12a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-3m-1 4l-3-3m0 0l-3 3m3-3v12" />
                  </svg>
                  Auto-Save Progress
                </span>
      ...
      >
        <div className="min-h-full flex items-center justify-center p-4">
          ...
          <div className="p-3 space-y-1">
            ...
            {/* Copy Debug Info */}
            <button
              onClick={() => { onCopyDebugInfo(); onClose() }}
              className="flex w-full items-center gap-3 px-3 py-2 text-sm text-foreground-muted rounded-lg hover:bg-btn-hover"
            >
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
