      ...
      <div className="content-grid sm:grid-cols-2 mb-10">
        ...
        <div className="content-card rounded-lg border border-board-border-light bg-background-secondary p-5">
          ...
          <p className="text-sm text-foreground-muted">
            ...
            to apply it. Highlighted cells show you the pattern in action.
          </p>
        </div>
        ...
        <div className="content-card rounded-lg border border-board-border-light bg-background-secondary p-5">
          ...
          <p className="text-sm text-foreground-muted">
            ...
            Naked Singles to advanced Forcing Chains — learn them all.
          </p>
        ...
        <div className="content-card rounded-lg border border-board-border-light bg-background-secondary p-5">
          ...
          <p className="text-sm text-foreground-muted">
            ...
            using basic techniques, then work your way up as you master new skills.
          </p>
        </div>
      </div>
          ...
          <div className="space-y-4">
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-foreground-muted">
                  Detects when you place the same digit twice in a row, column, or box. Explains
                  exactly which cells conflict.
                </p>
              </div>
            </div>
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-foreground-muted">
                  Finds when your entry eliminates all possibilities for another cell. Traces the
                  logical chain to identify the problem.
                </p>
              </div>
            </div>
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-foreground-muted">
                  When errors can't be traced to a single cell, provides guidance based on the
                  number of user entries to help you recover.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-foreground-muted">
                Install as a PWA and play anywhere, anytime — no internet required after first
                visit. Lightning-fast ~170KB initial load with aggressive caching.
              </p>
            </div>
          </div>
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-foreground-muted">
                The best way to learn techniques is to use them on real puzzles. Our hints guide you
                without robbing you of the satisfaction of solving.
              </p>
            </div>
          </div>
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-foreground-muted">
                Every puzzle can be solved using logic alone. Our techniques prove each step — no
                bifurcation or trial-and-error needed.
              </p>
            </div>
          </div>
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-foreground-muted">
                Smart background handling pauses all operations when you switch away. Won't drain
                your battery if you forget it in a tab.
              </p>
            </div>
          </div>
        </div>
