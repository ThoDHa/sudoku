...
function EnsoLogo() {
  ...
  return <img src={src} alt="Enso" className="enso-logo" />
}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-sm rounded-xl bg-background-secondary p-6 shadow-theme">
            ...
            <p className="mb-6 text-sm text-foreground-muted">
              You have a{' '}
              <span className="capitalize font-medium">{inProgressGame?.difficulty}</span> game in
              progress. Starting a new game will abandon your current progress.
            </p>
