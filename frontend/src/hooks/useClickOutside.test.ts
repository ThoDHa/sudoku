...
function setupHook(element: HTMLElement | null, isActive: boolean, onClickOutside: () => void) {
  return renderHook(
...
describe('useClickOutside', () => {
  ...
  describe('Cleanup on Unmount', () => {
    ...
    it('does not attempt to remove listener when isActive was false', () => {
      ...
      expect(removeEventListenerSpy).not.toHaveBeenCalledWith('mousedown', expect.any(Function))
    })
  })
