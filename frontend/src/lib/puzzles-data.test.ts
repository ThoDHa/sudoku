...
vi.mock('../../puzzles.json', () => {
  // Givens as sequential leading indices, shared by several mock puzzles below.
  const sequentialGivens = {
    e: [
    ...
    default: {
      puzzles: [
        ...
        },
        {
          ...
          g: {
            e: [
              0, 1, 2, 9, 10, 11, 18, 19, 20, 27, 28, 29, 36, 37, 38, 45, 46, 47, 54, 55, 56, 63,
              64, 65, 72, 73, 74, 3, 4, 5, 12, 13, 14, 21, 22, 23, 30, 31, 32, 39,
            ],
            m: [
              0, 1, 2, 9, 10, 11, 18, 19, 20, 27, 28, 29, 36, 37, 38, 45, 46, 47, 54, 55, 56, 63,
              64, 65, 72, 73, 74, 3, 4, 5, 12, 13, 14, 21,
            ],
            h: [
              0, 1, 2, 9, 10, 11, 18, 19, 20, 27, 28, 29, 36, 37, 38, 45, 46, 47, 54, 55, 56, 63,
              64, 65, 72, 73, 74, 3,
