...
func detectNakedTriple(b *Board) *core.Move {
	for row := 0; row < 9; row++ {
		if move := findNakedTripleInUnit(b, getRowIndices(row), "row", row+1); move != nil {
			return move
		}
	}
	for col := 0; col < 9; col++ {
		if move := findNakedTripleInUnit(b, getColIndices(col), "column", col+1); move != nil {
			return move
		}
	}
	for box := 0; box < 9; box++ {
		if move := findNakedTripleInUnit(b, getBoxIndices(box), "box", box+1); move != nil {
			return move
		}
	}
	return nil
...
func detectHiddenTriple(b *Board) *core.Move {
	for row := 0; row < 9; row++ {
		if move := findHiddenTripleInUnit(b, getRowIndices(row), "row", row+1); move != nil {
			return move
		}
	}
	for col := 0; col < 9; col++ {
		if move := findHiddenTripleInUnit(b, getColIndices(col), "column", col+1); move != nil {
			return move
		}
	}
	for box := 0; box < 9; box++ {
		if move := findHiddenTripleInUnit(b, getBoxIndices(box), "box", box+1); move != nil {
			return move
		}
	}
	return nil
...
func detectNakedQuad(b *Board) *core.Move {
	for row := 0; row < 9; row++ {
		if move := findNakedQuadInUnit(b, getRowIndices(row), "row", row+1); move != nil {
			return move
		}
	}
	for col := 0; col < 9; col++ {
		if move := findNakedQuadInUnit(b, getColIndices(col), "column", col+1); move != nil {
			return move
		}
	}
	for box := 0; box < 9; box++ {
		if move := findNakedQuadInUnit(b, getBoxIndices(box), "box", box+1); move != nil {
			return move
		}
	}
	return nil
...
func detectHiddenQuad(b *Board) *core.Move {
	for row := 0; row < 9; row++ {
		if move := findHiddenQuadInUnit(b, getRowIndices(row), "row", row+1); move != nil {
			return move
		}
	}
	for col := 0; col < 9; col++ {
		if move := findHiddenQuadInUnit(b, getColIndices(col), "column", col+1); move != nil {
			return move
		}
	}
	for box := 0; box < 9; box++ {
		if move := findHiddenQuadInUnit(b, getBoxIndices(box), "box", box+1); move != nil {
			return move
		}
	}
	return nil
