...
var Puzzles = []PuzzleData{
	...
	// Medium tier (9).
	{Slug: "bug", Tier: "medium", PuzzleIndex: 17, Difficulty: "impossible", Description: "Bivalue Universal Grave - avoid patterns with multiple solutions"},
	...
	{Slug: "swordfish", Tier: "medium", PuzzleIndex: 931, Difficulty: "impossible", Description: "A 3x3 fish pattern for eliminations"},
	{Slug: "xyz-wing", Tier: "medium", PuzzleIndex: 37, Difficulty: "hard", Description: "A trivalue hinge with bivalue pincers"},

	// Hard tier (11).
	{Slug: "skyscraper", Tier: "hard", PuzzleIndex: 44, Difficulty: "impossible", Description: "A turbot fish variant for eliminations"},
	{Slug: "x-chain", Tier: "hard", PuzzleIndex: 77, Difficulty: "impossible", Description: "Chain of alternating strong/weak links for a single digit"},
	...
	{Slug: "medusa-3d", Tier: "hard", PuzzleIndex: 110, Difficulty: "impossible", Description: "Multi-digit coloring with strong/weak link chains"},
	...
	{Slug: "unique-rectangle-type-2", Tier: "hard", PuzzleIndex: 231, Difficulty: "impossible", PuzzleString: "000000030004000100080003006060300700005008400000001000020600070340092500098030020", Description: "Unique rectangle with extra candidates in roof cells - found in puzzle database"},
	...
	{Slug: "unique-rectangle-type-4", Tier: "hard", PuzzleIndex: 57, Difficulty: "impossible", Description: "Unique rectangle with hidden pair - found in puzzle database"},
